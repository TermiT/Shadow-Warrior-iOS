...
static struct {
    ...
    #if 1 //def __APPLE__
    {
        ...
        AVPlayer_CD_Init,
        AVPlayer_CD_Shutdown,
        AVPlayer_CD_Play,
        AVPlayer_CD_Stop,
        AVPlayer_CD_Pause,
        AVPlayer_CD_IsPlaying,
        AVPlayer_CD_SetVolume,
        UNSUPPORTED_MIDI,
    },
    #else
        UNSUPPORTED_COMPLETELY
    ...
    {
        OpenALDrv_GetError,
        OpenALDrv_ErrorString,
        OpenALDrv_PCM_Init,
        OpenALDrv_PCM_Shutdown,
        OpenALDrv_PCM_BeginPlayback,
        OpenALDrv_PCM_StopPlayback,
        OpenALDrv_PCM_Lock,
        OpenALDrv_PCM_Unlock,
        AVPlayer_CD_Init,
        AVPlayer_CD_Shutdown,
        AVPlayer_CD_Play,
        AVPlayer_CD_Stop,
